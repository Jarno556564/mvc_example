...
$html .= "<input type=\"text\" id=\"product_type_code\" name=\"product_type_code\" value=\"" . $result[0]['product_type_code'] . "\" required><br>";
$html .= "<label for=\"supplier_id\">Supplier ID:</label><br>";
$html .= "<input type=\"text\" id=\"supplier_id\" name=\"supplier_id\" value=\"" . $result[0]['supplier_id'] . "\" required><br>";
...
$html .= "<input type=\"text\" id=\"product_price\" name=\"product_price\" value=\"" . $result[0]['product_price'] . "\" required><br>";
$html .= "<label for=\"other_product_details\">Other Product Details:</label><br>";
$html .= "<input type=\"text\" id=\"other_product_details\" name=\"other_product_details\" value=\"" . $result[0]['other_product_details'] . "\" required><br><br>";
