...
$html .= "<input type=\"number\" id=\"product_type_code\" name=\"product_type_code\" value=\"\" required><br>";
$html .= "<label for=\"supplier_id\">Supplier ID:</label><br>";
$html .= "<input type=\"number\" id=\"supplier_id\" name=\"supplier_id\" value=\"\" required><br>";
...
$html .= "<input type=\"number\" id=\"product_price\" name=\"product_price\" value=\"\" step='0.01'required><br>";
$html .= "<label for=\"other_product_details\">Other Product Details:</label><br>";
$html .= "<input type=\"text\" id=\"other_product_details\" name=\"other_product_details\" value=\"\" required><br>";
$html .= "<label for=\"exp_date\">Experaton date:</label><br>";
$html .= "<input type=\"date\" id=\"exp_date\" name=\"exp_date\" value=\"\" required><br><br>";
